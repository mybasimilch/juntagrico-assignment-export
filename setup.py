...
import juntagrico_assignment_export
...
setup(
    name=juntagrico_assignment_export.name,
    version=juntagrico_assignment_export.version,
    packages=find_packages(),
    include_package_data=True,
    license='LPGLv3',  # example license
    description='juntagrico-assignment-export',
